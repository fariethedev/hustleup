 ...
 *
 * The per-option `description` was dropped when the picker moved from stacked tiles to
 * compact rows: it duplicated what `next` already says, for the one option that is actually
 * selected, and cost a line of height on every row.
 *
...
export const PAYMENT_METHODS = [
  { id: 'paypal',     label: 'PayPal', Mark: PayPalMark,    onLight: true,  next: "You'll be redirected to PayPal to approve this payment." },
  { id: 'blik',       label: 'BLIK', Mark: BlikMark,      onLight: true,  next: 'Enter the 6-digit BLIK code from your banking app to confirm.' },
  { id: 'apple_pay',  label: 'Apple Pay',        Mark: ApplePayMark,  onLight: true,  next: 'Confirm with Face ID or Touch ID on your device.' },
  { id: 'google_pay', label: 'Google Pay',        Mark: GooglePayMark, onLight: true,  next: 'Confirm in the Google Pay sheet on your device.' },
  { id: 'card',       label: 'Card',     Mark: CardMark,      onLight: false, next: "You'll enter your card details on the next step." },
];
