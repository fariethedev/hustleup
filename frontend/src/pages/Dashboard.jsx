      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-10">
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }}>
          ...
          {/* Control row: tabs grouped by who they serve, plus actions.
              ...
              turned that into several ragged, centred rows of tiny pills on a phone. Below
              `sm` it is now a single swipeable strip instead (justify-start, not centre: the
                    ...
                    bookings.map((booking) => {
                      ...
                      return (
                        ...
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-3">
                          ...
                          {/* Actions — wraps rather than overflowing: up to three or four
                              buttons can appear at once (Wire + Approve + Counter), and on a
