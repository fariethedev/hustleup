...
function CashStrip({ offer, viewerIsProposer }) {
  ...
  return (
    <div className={`flex items-center gap-2 px-2.5 py-1.5 rounded-lg border text-[10px] font-black tracking-widest ${
      phrase.viewerPays
...
function SideCard({ side, label }) {
  return (
    <div className="flex-1 min-w-0">
      <p className="text-[9px] font-black tracking-[0.2em] text-gray-600 mb-1.5">{label}</p>
      ...
      <div className="max-w-3xl mx-auto px-4 pt-6">
        ...
        {loading ? (
          ...
          <div className="py-20 text-center">
            ...
            <Link to="/explore" className="inline-block mt-4 px-6 py-2.5 rounded-full bg-[#CDFF00] text-black text-[10px] font-black tracking-widest">
              Browse listings
            </Link>
          </div>
        ) : (
            ...
            {rows.map((s) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className={`px-2.5 py-1 rounded-full border text-[9px] font-black tracking-widest ${STATUS_STYLES[s.status] || STATUS_STYLES.WITHDRAWN}`}>
                    {labelize(s.status)}
                  </span>
                </div>
