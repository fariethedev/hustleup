    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 mt-10">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-heading font-black text-white mb-2 uppercase tracking-tight">Welcome back</h1>
          <p className="text-gray-500 font-bold uppercase tracking-[0.3em] text-[10px]">Sign in to your account</p>
        </div>
        ...
        <div className="glass bg-black/60 border border-white/10 rounded-[2.5rem] p-10 shadow-2xl backdrop-blur-3xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-5 rounded-2xl bg-[#CDFF00] text-black font-black uppercase tracking-[0.2em] text-[11px] hover:scale-[1.02] active:scale-95 disabled:opacity-50 transition-all shadow-[0_20px_40px_rgba(205,255,0,0.15)] flex items-center justify-center gap-3 outline-none"
            >
              {loading ? 'Validating...' : <><LogIn className="w-5 h-5" /> Sign In</>}
            </button>
          </form>
          ...
          <p className="text-center mt-10 text-[10px] font-black text-gray-600 uppercase tracking-[0.2em]">
            ...
            <Link to="/register" className="text-[#CDFF00] hover:scale-105 inline-flex items-center gap-2 transition-transform">
              Join Syndicate <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </p>
        </div>
      </motion.div>
