...
import { CircleX, ScanEye, EyeClosed } from 'lucide-react';
...
export default function Login() {
  ...
  // Where signing in lands you — shared with the social callbacks below and with the guard
  // that catches an already-signed-in visitor opening /login. See utils/landing.js.
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  // Out of the tab order so keyboard users go password -> Sign in.
                  tabIndex={-1}
